- [Hướng Dẫn Vận Hành Và Giám Sát Oracle \& MongoDB Cho Người Mới Bắt Đầu](#hướng-dẫn-vận-hành-và-giám-sát-oracle--mongodb-cho-người-mới-bắt-đầu)
  ...
  - [Phần III: Bí Quyết Cho Người Mới](#phần-iii-bí-quyết-cho-người-mới)
    - [Checklist Hàng Ngày](#checklist-hàng-ngày)
    - [Công Cụ Hỗ Trợ](#công-cụ-hỗ-trợ)


# Hướng Dẫn Vận Hành Và Giám Sát Oracle & MongoDB Cho Người Mới Bắt Đầu
...
|--------|----------|----------|
| Full table scan | Docs Examined cao, nReturned thấp | Tạo index cho cột WHERE |
| Nhiều subquery | Câu lệnh phức tạp | Tách thành các bước đơn giản |
| Lock contention | Nhiều session cùng sql_id | Điều chỉnh logic ứng dụng |

**Mẹo cho người mới:** Sử dụng `EXPLAIN PLAN FOR` để phân tích kế hoạch thực thi SQL trước khi tối ưu.
...
## Phần III: Bí Quyết Cho Người Mới
